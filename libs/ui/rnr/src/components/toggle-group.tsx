...
import { ComponentProps, RefAttributes, createContext, useContext } from 'react';
...
function ToggleGroup({
  ...
  RefAttributes<ToggleGroupPrimitive.RootRef>) {
  return (
...
function ToggleGroupItem({
  ...
  VariantProps<typeof toggleVariants> &
  RefAttributes<ToggleGroupPrimitive.ItemRef> & {
    isFirst?: boolean;
    isLast?: boolean;
  }) {
