...
import React, { Fragment, ReactNode, RefAttributes, useId, useState } from 'react';
import {
  Platform,
  Pressable,
  type StyleProp,
...
function Menubar({
  ...
  ...props
}: MenubarPrimitive.RootProps & RefAttributes<MenubarPrimitive.RootRef>) {
  const id = useId();
...
function MenubarTrigger({
  className,
  ...props
}: MenubarPrimitive.TriggerProps & RefAttributes<MenubarPrimitive.TriggerRef>) {
...
function MenubarSubTrigger({
  ...
  RefAttributes<MenubarPrimitive.SubTriggerRef> & {
    children?: ReactNode;
...
function MenubarSubContent({
  className,
  ...props
}: MenubarPrimitive.SubContentProps & RefAttributes<MenubarPrimitive.SubContentRef>) {
  return (
...
function MenubarContent({
  ...
  RefAttributes<MenubarPrimitive.ContentRef> & {
...
function MenubarItem({
  ...
  RefAttributes<MenubarPrimitive.ItemRef> & {
    className?: string;
    inset?: boolean;
...
function MenubarCheckboxItem({
  ...
  RefAttributes<MenubarPrimitive.CheckboxItemRef> & {
    children?: ReactNode;
  }) {
  return (
...
function MenubarRadioItem({
  ...
  RefAttributes<MenubarPrimitive.RadioItemRef> & {
    children?: ReactNode;
  }) {
  return (
    <TextClassContext.Provider value="text-sm text-popover-foreground select-none group-active:text-accent-foreground">
...
function MenubarLabel({
  ...
  RefAttributes<MenubarPrimitive.LabelRef> & {
    className?: string;
    inset?: boolean;
  }) {
  return (
...
function MenubarSeparator({
  className,
  ...props
}: MenubarPrimitive.SeparatorProps & RefAttributes<MenubarPrimitive.SeparatorRef>) {
  return (
    <MenubarPrimitive.Separator className={cn('bg-border -mx-1 my-1 h-px', className)} {...props} />
  );
}

function MenubarShortcut({ className, ...props }: TextProps & RefAttributes<Text>) {
  return (
    <Text
