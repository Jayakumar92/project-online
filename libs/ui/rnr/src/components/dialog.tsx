...
function DialogOverlay({
  ...
  RefAttributes<DialogPrimitive.OverlayRef> & {
    children?: ReactNode;
  }) {
  return (
    <FullWindowOverlay>
...
function DialogContent({
  ...
  RefAttributes<DialogPrimitive.ContentRef> & {
    portalHost?: string;
  }) {
  return (
...
function DialogTitle({
  className,
  ...props
}: DialogPrimitive.TitleProps & RefAttributes<DialogPrimitive.TitleRef>) {
  return (
...
function DialogDescription({
  className,
  ...props
}: DialogPrimitive.DescriptionProps & RefAttributes<DialogPrimitive.DescriptionRef>) {
  return (
