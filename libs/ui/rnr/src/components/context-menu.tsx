...
function ContextMenuSubTrigger({
  ...
  RefAttributes<ContextMenuPrimitive.SubTriggerRef> & {
    children?: ReactNode;
...
function ContextMenuSubContent({
  className,
  ...props
}: ContextMenuPrimitive.SubContentProps & RefAttributes<ContextMenuPrimitive.SubContentRef>) {
  return (
...
function ContextMenuContent({
  ...
  RefAttributes<ContextMenuPrimitive.ContentRef> & {
...
function ContextMenuItem({
  ...
  RefAttributes<ContextMenuPrimitive.ItemRef> & {
    className?: string;
    inset?: boolean;
...
function ContextMenuCheckboxItem({
  ...
  RefAttributes<ContextMenuPrimitive.CheckboxItemRef> & {
    children?: ReactNode;
  }) {
  return (
...
function ContextMenuRadioItem({
  ...
  RefAttributes<ContextMenuPrimitive.RadioItemRef> & {
    children?: ReactNode;
  }) {
  return (
    <TextClassContext.Provider value="text-sm text-popover-foreground select-none group-active:text-accent-foreground">
...
function ContextMenuLabel({
  ...
  RefAttributes<ContextMenuPrimitive.LabelRef> & {
    className?: string;
    inset?: boolean;
  }) {
  return (
...
function ContextMenuSeparator({
  className,
  ...props
}: ContextMenuPrimitive.SeparatorProps & RefAttributes<ContextMenuPrimitive.SeparatorRef>) {
  return (
...
function ContextMenuShortcut({ className, ...props }: TextProps & RefAttributes<Text>) {
  return (
    <Text
