...
function DropdownMenuSubContent({
  className,
  ...props
}: DropdownMenuPrimitive.SubContentProps & RefAttributes<DropdownMenuPrimitive.SubContentRef>) {
  return (
...
function DropdownMenuSeparator({
  className,
  ...props
}: DropdownMenuPrimitive.SeparatorProps & RefAttributes<DropdownMenuPrimitive.SeparatorRef>) {
  return (
...
function DropdownMenuShortcut({ className, ...props }: TextProps & RefAttributes<Text>) {
  return (
    <Text
