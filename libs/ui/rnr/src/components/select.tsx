...
import React, { ComponentProps, Fragment, ReactNode, RefAttributes } from 'react';
...
function SelectValue({
  ...
  RefAttributes<SelectPrimitive.ValueRef> & {
    className?: string;
  }) {
...
function SelectTrigger({
  ...
  RefAttributes<SelectPrimitive.TriggerRef> & {
    children?: ReactNode;
    size?: 'default' | 'sm';
  }) {
  return (
...
function SelectContent({
  ...
  RefAttributes<SelectPrimitive.ContentRef> & {
    className?: string;
    portalHost?: string;
  }) {
  return (
...
function SelectLabel({
  className,
  ...props
}: SelectPrimitive.LabelProps & RefAttributes<SelectPrimitive.LabelRef>) {
  return (
...
function SelectItem({
  ...
  children,
  ...props
}: SelectPrimitive.ItemProps & RefAttributes<SelectPrimitive.ItemRef>) {
  return (
...
function SelectSeparator({
  className,
  ...props
}: SelectPrimitive.SeparatorProps & RefAttributes<SelectPrimitive.SeparatorRef>) {
  return (
 ...
 */
function NativeSelectScrollView({ className, ...props }: ComponentProps<typeof ScrollView>) {
  if (Platform.OS === 'web') {
